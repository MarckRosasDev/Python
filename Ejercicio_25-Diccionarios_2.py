...
Caricatura = {
    ...
    "frases_celebres": ["¡Ay, caramba!", "¡Miau!", "¡No puedo creerlo!", "¡Esto sí que es un lío!", "¡Estoy bien, estoy bien!"],
    "relaciones": {
...
print()
existe_nombre = 'nombre' in Caricatura # Verifica si una clave específica existe en el diccionario.
...
diccionario.update(datos_nuevos) # Actualiza el diccionario con pares clave-valor de otro diccionario o un objeto
print(f"Diccionario actualizado: {diccionario}")
print()
ciudad = diccionario.pop("ciudad") # Elimina un elemento del diccionario por su clave y devuelve el valor asociado.
...
print()
cantidad_elementos = len(Caricatura) # Devuelve la cantidad de elementos (pares clave-valor) en el diccionario.
...
copia_diccionario = diccionario.copy() # Crea una copia superficial del diccionario. Los cambios en la copia no afectan al original.
