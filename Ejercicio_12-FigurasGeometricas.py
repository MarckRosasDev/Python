...
La cantidad de dígitos decimales que se muestran después del punto decimal se puede ajustar
modificando el formateador de número, por ejemplo, :.3f para tres decimales o :.4f para
cuatro decimales.
"""
print("---------")
